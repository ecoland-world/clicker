...
const TRIGGERS = {
  TUTO_B: {
    text: "Now you can afford another WHEAT_FIELD Dwarf to get more gold!\nHire Him!",
    watch: "game.money",
    condition: 400,
    arrow: "WHEAT_FIELD.invest",
    nextTrigger: "TUTO_C",
  },
  TUTO_C: {
    text: "Keep going!\nMining gold requires hard work!",
    watch: "businesses.WHEAT_FIELD.investments",
    condition: 2,
    keepOpen: true,
