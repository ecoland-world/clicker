...
export default class HUDGameScene extends MainScene {
  constructor() {
  ...
  create(params) {
    ...
    this.moneyLabel = this.add.text(620, 120, "0", {
    ...
    // profile
    this.nameLabel = this.add.text(170, 45, gs.stats.character.name, {
      fontFamily: "CalvertMT-Bold",
      color: "#ffb200",
      align: "left",
      fontSize: "30px",
    ...
    this.titleLabel = this.add.text(170, 80, gs.stats.character.title, {
      fontFamily: "CalvertMT-Bold",
      color: "#fff",
      align: "left",
      fontSize: "22px",
    ...
    gs.setListener(
      "character.title",
      (title) => (this.titleLabel.text = title)
    );
    ...
    gs.setListener(
      "character.level",
      (level) => (this.levelLabel.text = `Level ${level}`)
    );
  ...
  buildInfoContainer() {
    ...
    let king = this.add.sprite(600, 0, "farmerGirl");
    king.setOrigin(1, 1);
    ...
    this.infoText = this.add.text(50, 20, gs.stats.tutorial.text, {
      fontFamily: "CalvertMT-Bold",
      color: "#fff",
      align: "left",
      fontSize: "32px",
